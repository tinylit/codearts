...
namespace CodeArts.ORM.Common
{
    ...
    public class DbParameterCollection : IDataParameterCollection
    {
        ...
        /// <inheritdoc />
        internal DbParameterCollection(IDataParameterCollection parameters, ISQLCorrectSimSettings settings)
        {
        ...
        /// <inheritdoc />
        public object this[string parameterName] { get => parameters[GetParameterName(parameterName)]; set => parameters[GetParameterName(parameterName)] = value; }
        object IList.this[int index] { get => parameters[index]; set => parameters[index] = value; }
