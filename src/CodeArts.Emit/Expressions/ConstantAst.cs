...
namespace CodeArts.Emit.Expressions
{
    ...
    public class ConstantAst : AstExpression
    {
        ...
        public ConstantAst(object value) : this(value, (value is MethodInfo || value is MethodEmitter) ? typeof(MethodInfo) : (value is Type || value is AbstractTypeEmitter) ? typeof(Type) : value?.GetType() ?? typeof(object))
        {
        }
