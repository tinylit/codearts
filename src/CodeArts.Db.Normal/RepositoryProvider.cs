...
namespace CodeArts.Db
{
    ...
    public abstract class RepositoryProvider : IDbRepositoryProvider, IDbRepositoryExecuter
    {
        ...
        protected virtual void AddParameterAuto(DbCommand command, object param = null) => DbWriter.AddParameterAuto(command, param);
        ...
        protected virtual void AddParameterAuto(DbCommand command, string key, ParameterValue value) => DbWriter.AddParameterAuto(command, key, value);
        ...
        /// <param name="key">参数名称。</param>
        /// <param name="value">参数值。</param>
        protected virtual void AddParameterAuto(DbCommand command, string key, object value) => DbWriter.AddParameterAuto(command, key, value);
