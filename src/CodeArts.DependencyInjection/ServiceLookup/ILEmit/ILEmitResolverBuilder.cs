...
namespace Microsoft.Extensions.DependencyInjection.ServiceLookup
{
    ...
    {
        private static readonly PropertyInfo ResolvedServicesProperty = typeof(ServiceProviderEngineScope).GetProperty(
             nameof(ServiceProviderEngineScope.ResolvedServices), BindingFlags.Instance | BindingFlags.NonPublic);

        private static readonly MethodInfo ResolvedServicesGetter = ResolvedServicesProperty
            .GetGetMethod() ?? ResolvedServicesProperty
            .GetGetMethod(true);
        ...
        private static readonly ConstructorInfo CacheKeyCtor = typeof(ServiceCacheKey).GetConstructor(new Type[] { typeof(Type), typeof(int) });
