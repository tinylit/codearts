...
namespace CodeArts.Db.EntityFramework
{
    ...
    public class Repository<TEntity> : IRepository<TEntity>, IRepository, IQueryable<TEntity>, IEnumerable<TEntity>, IQueryable, IEnumerable where TEntity : class, IEntiy
    {
        ...
        public Repository(IReadOnlyConnectionConfig connectionConfig)
        {
            ...
            _dbContext = Create(connectionConfig);
            _dbSet = _dbContext.Set<TEntity>();
            _dbQueryable = _dbSet.AsQueryable();
        }
        ...
        /// <returns></returns>
        protected virtual DbContext<TEntity> Create(IReadOnlyConnectionConfig connectionConfig)
            => new DbContext<TEntity>(connectionConfig);
        ...
        /// <returns></returns>
#if NETSTANDARD2_0
        public IQueryable<TEntity> FromSql(SQL sql, params object[] parameters) => _dbContext.FromSql(sql, parameters);
#else
        public DbRawSqlQuery<TEntity> FromSql(SQL sql, params object[] parameters) => _dbContext.FromSql(sql, parameters);
#endif
        ...
        /// 数据库上下文。
        /// </summary>
        DbContext IRepository.DBContext => _dbContext;
    ...
    public class Repository<TEntity, TKey> : Repository<TEntity>, IRepository<TEntity, TKey>, IQueryable<TEntity>, IEnumerable<TEntity>, IQueryable, IEnumerable
        ...
        where TKey : IEquatable<TKey>, IComparable<TKey>
    {
        ...
        /// inheritdoc
        /// </summary>
        public Repository(IReadOnlyConnectionConfig connectionConfig) : base(connectionConfig)
        {
        ...
        /// inheritdoc
        /// </summary>
        public Repository(DbContext<TEntity> dbContext) : base(dbContext)
        {
        }
