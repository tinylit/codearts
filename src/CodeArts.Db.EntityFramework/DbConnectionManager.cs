...
namespace CodeArts.Db.EntityFramework
{
    ...
    public static class DbConnectionManager
    {
...
#else
        private static readonly ConcurrentDictionary<string, IDbConnectionSimAdapter> Adapters;
#endif
        ...
        /// </summary>
#if NETSTANDARD2_0
        static DbConnectionManager() => Adapters = new ConcurrentDictionary<string, IDbConnectionAdapter>();
#else
        static DbConnectionManager() => Adapters = new ConcurrentDictionary<string, IDbConnectionSimAdapter>();
#endif
...
#else
        public static void RegisterAdapter(IDbConnectionSimAdapter adapter)
#endif
        {
            if (adapter is null)
            {
...
#else
        public static IDbConnectionSimAdapter Get(string providerName)
#endif
        {
