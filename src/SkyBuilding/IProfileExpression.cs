...
namespace SkyBuilding
{
    ...
    public interface IProfileExpression
    {
        ...
        void Map<TResult>(Type sourceType, Func<object, TResult> plan);
        ...
        /// <param name="plan">将对象转为目标类型的方案</param>
        void Map<TResult>(Predicate<Type> predicate, Func<object, TResult> plan);
        ...
        void Run<TSource, TResult>(Func<TSource, TResult> plan);
    }
}
